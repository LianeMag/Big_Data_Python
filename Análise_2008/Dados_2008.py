...
votacao_doismileoito = pd.read_csv(r'C:\Users\Liane\Documents\GitHub\Big_data_py\Big_data_py\Análise_2008\votacao_candidato_munzona_2008_RJ.csv', sep=';', encoding='latin1')

print(votacao_doismileoito.columns) 
'''olhando as colunas de primeira, temos o seguinte resultado: Index(['DT_GERACAO', 'HH_GERACAO', 'ANO_ELEICAO', 'CD_TIPO_ELEICAO','NM_TIPO_ELEICAO', 'NR_TURNO', 'CD_ELEICAO', 'DS_ELEICAO', 'DT_ELEICAO',
'TP_ABRANGENCIA', 'SG_UF', 'SG_UE', 'NM_UE', 'CD_MUNICIPIO','NM_MUNICIPIO', 'NR_ZONA', 'CD_CARGO', 'DS_CARGO', 'SQ_CANDIDATO',
...
eleitores_doismileoito = pd.read_csv(r'C:\Users\Liane\Documents\GitHub\Big_data_py\Big_data_py\Análise_2008\Eleitorado­_Município_2008.csv', sep=';', encoding='latin1')
